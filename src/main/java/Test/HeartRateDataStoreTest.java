...
public class HeartRateDataStoreTest {
    ...
    public void setUp() {
        ...
        List<ClientMesuramentAverage> testData = Arrays.asList(
                new ClientMesuramentAverage("player1", Arrays.asList(60f, 70f, 80f), 1000),
                new ClientMesuramentAverage("player2", Arrays.asList(65f, 75f), 2000),
                new ClientMesuramentAverage("player3", Collections.emptyList(), 3000)
        );
